/*
** Cmp4071.cpp for nanotekspice in /home/uberti_p/delivery/nanotekspice/Cmp4071.cpp
**
** Made by Louis-Emile Uberti-Ares
** Login   <louis-emile.uberti-ares@epitech.eu>
**
** Started on  jeu. févr. 02 16:00:14 2017 Louis-Emile Uberti-Arès
** Last update jeu. févr. 02 16:00:14 2017 Louis-Emile Uberti-Arès
*/

#include "Cmp4071.hpp"

nts::Cmp4071::Cmp4071(const std::string &value) :
...
nts::Tristate       nts::Cmp4071::Compute(size_t pin_num_this)
{
    nts::Tristate   cmp1;
    nts::Tristate   cmp2;
...
void                nts::Cmp4071::SetLink(size_t pin_num_this, nts::IComponent &component, size_t pin_num_target)
{
...
void                nts::Cmp4071::Dump() const
{
    std::cout << "\tType : 4071" << std::endl;
}