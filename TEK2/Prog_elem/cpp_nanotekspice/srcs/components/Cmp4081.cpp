/*
** Cmp4081.cpp for nanotekspice in /home/uberti_p/delivery/nanotekspice/Cmp4081.cpp
**
** Made by Louis-Emile Uberti-Ares
** Login   <louis-emile.uberti-ares@epitech.eu>
**
** Started on  jeu. févr. 02 16:01:03 2017 Louis-Emile Uberti-Arès
** Last update jeu. févr. 02 16:01:03 2017 Louis-Emile Uberti-Arès
*/

#include "Cmp4081.hpp"

nts::Cmp4081::Cmp4081(const std::string &value) :
...
nts::Tristate       nts::Cmp4081::Compute(size_t pin_num_this)
{
    nts::Tristate   cmp1;
    nts::Tristate   cmp2;
...
void                nts::Cmp4081::SetLink(size_t pin_num_this, nts::IComponent &component, size_t pin_num_target)
{
...
void            nts::Cmp4081::Dump() const
{
    std::cout << "\tType : 4081" << std::endl;
}