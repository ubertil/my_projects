/*
** struct_handler.c for struct_handler.c in /home/trognot/rendu/IA/dante/largeur
**
** Made by nicolas trognot
** Login   <nicolas.trognot@epitech.eu>
**
** Started on  Thu May 19 02:51:05 2016 nicolas trognot
** Last update Fri May 27 15:04:09 2016 louis-emile uberti-ares
*/
...
int		open_file(t_maze *maze, char *filepath)
{
  ...
  if (transfer_wt_to_cells(maze, wt) == 1)
    return (0);
  return (1);
}
