/*
** print_help.c for print_help in /home/uberti_l/rendu/Unix/PSU_2015_tetris
**
** Made by louis-emile uberti-ares
** Login   <uberti_l@epitech.net>
**
** Started on  Mon Feb 22 14:04:50 2016 louis-emile uberti-ares
** Last update Sat Mar 19 21:56:35 2016 Louis-Emile Uberti
*/
...
void		print_help(char **av)
{
  ...
  my_putstr(" --key-pause={K}\tPause and restart game when press key K\n");
