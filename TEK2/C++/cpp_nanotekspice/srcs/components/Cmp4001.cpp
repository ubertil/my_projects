/*
** Cmp4001.cpp for nanotekspice in /home/uberti_p/delivery/nanotekspice/Cmp4001.cpp
**
** Made by Louis-Emile Uberti-Ares
** Login   <louis-emile.uberti-ares@epitech.eu>
**
** Started on  jeu. févr. 02 15:38:31 2017 Louis-Emile Uberti-Arès
** Last update jeu. févr. 02 15:38:31 2017 Louis-Emile Uberti-Arès
*/

#include "Cmp4001.hpp"

nts::Cmp4001::Cmp4001(const std::string &value) :
...
nts::Tristate       nts::Cmp4001::Compute(size_t pin_num_this)
{
    nts::Tristate   cmp1;
    nts::Tristate   cmp2;
    ...
    if (cmp1 == nts::Tristate::TRUE || cmp2 == nts::Tristate::TRUE)
...
void            nts::Cmp4001::SetLink(size_t pin_num_this, nts::IComponent &component, size_t pin_num_target)
{
...
void            nts::Cmp4001::Dump() const
{
    std::cout << "\tType : 4001" << std::endl;
}